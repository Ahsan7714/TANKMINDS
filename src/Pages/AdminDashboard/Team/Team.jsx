  ...
  return (
    <div className="flex gap-2">
      ...
      <div className="ml-[35%] w-[70%] py-10 flex flex-col gap-10">
        <div>
          <h1 className="ml-[30%] text-[35px] py-4">Team</h1>
        ...
        <div className=" bg-[#f3f4f6] shadow-lg rounded-lg  w-[80%]">
          <h1 className=" text-center text-[28px] pt-6">Add New Lawyer</h1>
          <form action="" onSubmit={handleSubmit} className="flex flex-col gap-10 p-10">
            ...
            <div className="flex justify-between">
             ...
             <div className="flex justify-end"><button className="h-[50px] w-[130px] rounded-lg bg-[#003268] text-white">Add lawyer</button></div>
              </div>
