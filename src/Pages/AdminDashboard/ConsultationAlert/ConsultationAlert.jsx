  ...
  return (
    <div className="flex gap-2">
      ...
      <div className="ml-[27%] w-[70%] py-10 flex flex-col gap-10">
        <div>
          <h1 className="text-center text-[30px] pb-4">Consultation Alerts</h1>
                ...
                {rows.map((row) => (
                  <TableRow hover role="checkbox" tabIndex={-1} key={row.id}>
                    ...
                    <TableCell align="center">
                      ...
                      >
                        <MenuItem value="Active" className=" text-[10px]">Consultation Given</MenuItem>
        ...
        <div>
          <h1 className="text-center text-[30px] py-4">Closed Consultations</h1>
        <Paper sx={{ width: "100%", overflow: "hidden" }}>
          <TableContainer sx={{ maxHeight: 440 }}>
            <Table
              stickyHeader
